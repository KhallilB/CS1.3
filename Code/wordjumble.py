...
print('unjumbled: ', jumble1, 'is',
      find_anagrams(jumble1, test_anagram_dict))
print('unjumbled: ', jumble2, 'is',
      find_anagrams(jumble2, test_anagram_dict))
print('unjumbled: ', jumble3, 'is',
      find_anagrams(jumble3, test_anagram_dict))
print('unjumbled: ', jumble4, 'is',
      find_anagrams(jumble4, test_anagram_dict))
